...
copy "%ProgramFiles(x86)%\Razer\Synapse3\UserProcess\NLog.config" "%ProgramFiles(x86)%\Razer\Synapse3\UserProcess\NLog.config.bak"
...
powershell -Command "(gc '%ProgramFiles(x86)%\Razer\Synapse3\UserProcess\NLog.config') -replace 'c:\\temp', 'c:\windows\temp' | Out-File -encoding utf8 '%ProgramFiles(x86)%\Razer\Synapse3\UserProcess\NLog.config' "
